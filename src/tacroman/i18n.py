...
_MESSAGES: dict[str, Mapping[str, str]] = {
    ...
    "citation_migration_summary": {
        "de": "{changed} Schlüssel können geändert werden · {unchanged} bereits identisch · {ambiguous} unklar · {unmatched} nicht gefunden.",
        "en": "{changed} keys can be changed · {unchanged} already identical · {ambiguous} ambiguous · {unmatched} unmatched.",
    },
